...
//List of tests
//    V4L2StreamTest
//   StreamDepth_640x480_5FPS
//   StreamDepth_640x480_30FPS
//   StreamDepth_640x480_5FPS_MetaData
//   StreamDepth_640x480_30FPS_MetaData
//   StreamDepth_1280x960_30FPS_HDR_HMC
//   StreamDepth_1280x960_30FPS_MetaData
//   StreamRGB_1920x1080_5FPS
//   StreamRGB_1920x1080_30FPS
...
TEST_F(V4L2StreamTest, StreamDepth_640x480_5FPS) {
    ...
    std::array<void*, numberOfBuffers> buffers {};
    ...
    const int framesToGet = 50;
    std::array<void*, framesToGet> framesArray {};
    ...
    for (int i = 0; i < framesToGet; ++i) {
        ...
        framesArray[i] = &v4l2Buffer;
        //cout << "ID= " << i << " = " << v4l2Buffer.sequence << "\n";
...
TEST_F(V4L2StreamTest, StreamDepth_640x480_15FPS) {
    string mdVideoNode = {"/dev/video0"};
    int depth_fd = open(mdVideoNode.c_str(), O_RDWR);
    ASSERT_TRUE(0 < depth_fd);
